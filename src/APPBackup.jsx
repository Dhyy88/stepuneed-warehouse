...
// Master Sales Pages
const SalesListExternal = lazy(() =>
  import("./pages/MasterSales/sales_list_external")
);
const SalesListInternal = lazy(() =>
  import("./pages/MasterSales/sales_list_internal")
);

const DetailSalesExternal = lazy(() =>
  import("./pages/MasterSales/detail_sales_external")
);

// Master Divisi
const DealerList = lazy(() => import("./pages/MasterDivisi/MasterDealer/dealer_list"));
const SiteList = lazy(() => import("./pages/MasterDivisi/MasterSite/site_list"));
const CreateSite = lazy(() => import("./pages/MasterDivisi/MasterSite/create_site"));
const UpdateSite = lazy(() => import("./pages/MasterDivisi/MasterSite/update_site"));
    ...
    <main className="App  relative">
      <Routes>
        ...
        <Route path="/*" element={<Layout />}>
          ...
          <Route path="table" element={<TableAdvancedPage />} />
          ...
          {/* Route Sales */}
          <Route path="sales-list-external" element={<SalesListExternal />} />
          <Route path="sales-list-internal" element={<SalesListInternal />} />
          <Route path="detail-sales-external/:uid" element={<DetailSalesExternal />} />

          {/* Route Divisi */}
          <Route path="dealer" element={<DealerList /> } />
          <Route path="cabang" element={<SiteList />} />
          <Route path="tambah-cabang" element={<CreateSite />} />
          <Route path="ubah-cabang/:uid" element={<UpdateSite />} />
