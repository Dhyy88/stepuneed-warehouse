...
const Setings = () => {
  ...
  return (
    <div>
      {!isOpen && (
        <span
          className="fixed ltr:md:right-[-32px] print:hidden ltr:right-0 rtl:left-0 rtl:md:left-[-32px] top-1/2 z-[888] translate-y-1/2 bg-slate-800 text-slate-50 dark:bg-slate-700 dark:text-slate-300 cursor-pointer transform rotate-90 flex items-center text-sm font-medium px-2 py-2 shadow-deep ltr:rounded-b rtl:rounded-t"
